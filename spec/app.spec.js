...
describe("/api", () => {
  ...
  describe("/api", () => {
    describe("GET", () => {
      it("status: 200, it returns a json with all available endpoints", () => {
  ...
  describe("/topics", () => {
    ...
    describe("INVALID METHODS", () => {
      it("status: 405, responds with error message when method not allowed", () => {
        const notAllowed = ["post", "patch", "put", "delete"];
  ...
  describe("/comments/:comment_id", () => {
    describe("PATCH", () => {
      it("status: 200, updates votes and returns updated comment", () => {
        return request(app)
      ...
      it("status: 404, returns error message when comment id does not exist", () => {
        return request(app)
      ...
      it("status: 400, returns error message when body does not have inc_votes", () => {
        return request(app)
          .patch("/api/comments/1")
          .send({ balls: 1 })
          .expect(400)
          .then(({ body: { msg } }) => {
            expect(msg).to.equal("body must contain inc_votes");
          });
      });
    });
    describe("DELETE", () => {
      it("status: 204, it deletes comment by comment id", () => {
        return request(app)
